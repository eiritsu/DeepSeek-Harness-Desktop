...
The menu, Modal, and buttons retain their existing structure and design tokens. Permanent Session deletion is a separate action owned by the [Session deletion decision](2026-08-23-permanent-session-deletion.md); it does not change this registration-only boundary.
