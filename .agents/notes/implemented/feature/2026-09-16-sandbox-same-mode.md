...
Bash and filesystem tools accept repeated effective modes without an approval service or agent. Shared unit tests cover both advertised targets, and each tool consumer executes the repeated mode.
