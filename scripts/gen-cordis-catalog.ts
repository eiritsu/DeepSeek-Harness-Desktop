...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SessionResendRequest: 'session.md',
  SessionResendValue: 'session.md',
  SessionResumeRequest: 'session.md',
  SessionResumeValue: 'session.md',
  ...
  AttachmentRecognizer: 'attachment.md',
  AttachmentRecognitionResult: 'attachment.md',
  ...
  RecognizableAttachmentRef: 'attachment.md',
  ...
  WorkspaceAttachSessionValue: 'workspace.md',
  ...
  ExternalToolStatus: 'extensions.md',
  LarkApplicationInput: 'extensions.md',
  LarkManagedRegistrationRequest: 'extensions.md',
  LarkManagementStatus: 'extensions.md',
  LarkUserAuthRequest: 'extensions.md',
