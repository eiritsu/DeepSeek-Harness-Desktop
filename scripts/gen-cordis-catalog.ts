...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LegacyModelModality: 'llm-streaming.md',
  LlmModelMetadataEnricher: 'llm-streaming.md',
  LlmModelDiscoveryEnricher: 'llm-streaming.md',
  ...
  FileRecognitionInput: 'attachment.md',
  FileRecognitionResult: 'attachment.md',
  FileRecognizer: 'attachment.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ExternalToolStatus: 'package-local status record is documented by packages/extensions/external-tools/README.md',
  ...
  SessionDeleteRequest: 'session-controller request contract is owned by packages/api/session-controller/src/types.ts',
  SessionDeleteValue: 'session-controller response contract is owned by packages/api/session-controller/src/types.ts',
  WorkspaceAttachSessionRequest: 'workspace-controller request contract is owned by packages/api/workspace-controller/src/types.ts',
  WorkspaceAttachSessionValue: 'workspace-controller response contract is owned by packages/api/workspace-controller/src/types.ts',
