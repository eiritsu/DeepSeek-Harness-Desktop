...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  LlmModelDiscoveryEnrichmentRequest: 'llm-streaming.md',
  LlmModelDiscoveryEnricher: 'llm-streaming.md',
  LlmModelInputRequest: 'llm-streaming.md',
  LlmModelInputResolver: 'llm-streaming.md',
  LlmModelCapacity: 'llm-streaming.md',
  LlmModelCapacityRequest: 'llm-streaming.md',
  LlmModelCapacityResolver: 'llm-streaming.md',
  ModelModality: 'llm-streaming.md',
