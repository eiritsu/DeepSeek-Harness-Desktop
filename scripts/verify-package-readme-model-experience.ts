...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/runtime': { kind: 'none', reason: 'Browser-side compatibility exports; current owner packages provide every implementation and nothing is model-facing.' },
  ...
  'packages/client/ui-plugin-library': { kind: 'none', reason: 'Desktop-only plugin management UI; registers nothing model-facing.' },
