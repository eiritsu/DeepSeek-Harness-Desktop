...
class RecordingAttachmentStore extends AttachmentStore {
  ...
  saveFile(): Promise<never> { return Promise.reject(new Error('MCP fixture does not save generic files')) }
  readFile(): Promise<never> { return Promise.reject(new Error('MCP fixture does not read generic files')) }
