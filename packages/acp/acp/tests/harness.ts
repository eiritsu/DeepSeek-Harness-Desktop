...
class MemoryAttachmentStore extends AttachmentStore {
  ...
  saveFile(): Promise<never> { return Promise.reject(new Error('ACP fixture does not save generic files')) }
  readFile(): Promise<never> { return Promise.reject(new Error('ACP fixture does not read generic files')) }
