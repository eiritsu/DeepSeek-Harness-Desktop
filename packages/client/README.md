...
| [`ui-plugin-library/`](ui-plugin-library/README.md) | Adds desktop-only plugin discovery, source review, installation, and audit surfaces | — |
| [`runtime/`](runtime/README.md) | Keeps pre-split browser plugins loading while forwarding their shared store and settings imports to current owners | — |
