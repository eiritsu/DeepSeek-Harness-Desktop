...
export const zh = {
  ...
  installed: '已安装', review: '审查安装', discovery: '社区发现', logs: '操作日志', installedEmpty: '尚未发现已安装的技能。通过技能库导入的文件会保存在 Application Support。', reviewEmpty: '技能来源审查和导入将在桌面技能运行时接入。', logsEmpty: '暂无技能操作记录。', skillSort: '技能排序', sourceSkillHub: 'SkillHub',
...
export const en = {
  ...
  installed: 'Installed', review: 'Review & install', discovery: 'Community discovery', logs: 'Operation log', installedEmpty: 'No installed skills were found. Files imported from the library are stored in Application Support.', reviewEmpty: 'Skill source review and import will connect to the desktop skill runtime.', logsEmpty: 'No skill operations have been recorded.', skillSort: 'Skill sorting', sourceSkillHub: 'SkillHub',
