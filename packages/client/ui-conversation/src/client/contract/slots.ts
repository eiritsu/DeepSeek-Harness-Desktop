...
import type { AttachmentRef, FileAttachmentRef, ImageAttachmentRef } from '@deepseek-ai/dsh-attachment'
import type {
...
export interface MessageImagesOwnerProps {
  ...
  /** Generic file blocks rendered as downloadable cards. */
  files: readonly { readonly attachment: FileAttachmentRef }[]
  /** Session-authorized durable image loader. */
  loadImage: (attachment: AttachmentRef) => Promise<string>
...
export interface ComposerBarInjected {
  ...
  /** Toggle the shared Add launcher; absent without ui-input-trigger or a session. */
...
export interface ChatViewInjected {
  ...
  loadOlder: () => void
  /** Resolve a session-authorized historical attachment for display or download. */
  loadImage: (attachment: AttachmentRef) => Promise<string>
