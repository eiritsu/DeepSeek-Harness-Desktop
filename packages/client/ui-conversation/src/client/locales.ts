...
export const zh = {
  ...
  'attachment.filesAndFolders': '添加文件或文件夹',
...
export const en = {
  ...
  'attachment.remove': 'Remove file {name}',
  'attachment.filesAndFolders': 'Add files or folders',
  'attachment.folder': 'Choose a folder',
