...
export const zh = {
  ...
  'input.commands': '添加',
  'add.section': '添加',
  'attachment.filesAndFolders': '文件与文件夹',
  ...
  'attachment.dropDesc': '图片：最多 {imageCount} 张，每张 {imageSize}；文件：最多 {fileCount} 个，每个 {fileSize}',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter 插话发送全部排队消息',
  'input.accessMode': '访问模式，当前：{name}',
  'image.dropTitle': '将文件或文件夹拖动到此处即可添加',
  'image.dropDesc': '最多 {count} 项，每项 {size}',
  ...
  'file.invalid': '文件信息无效，请重新添加后再试',
  'file.subagentUnsupported': '子智能体会话暂不支持文件附件',
  'attachment.sendFailed': '附件发送失败（{reason}），请重新添加后再试',
  'image.pending': '待发送图片',
...
export const en = {
  ...
  'input.commands': 'Add',
  'add.section': 'Add',
  'attachment.filesAndFolders': 'Files and folders',
  'attachment.pickerTitle': 'Add files and folders',
  'attachment.pickFiles': 'Choose files',
  'attachment.pickFolder': 'Choose folder',
  'attachment.pickerCancel': 'Cancel',
  'attachment.pending': 'Pending attachments',
  'attachment.dropDesc': 'Images: {imageCount} up to {imageSize} each; files: {fileCount} up to {fileSize} each',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter steers all queued messages',
  'input.accessMode': 'Access mode, current: {name}',
  'image.dropTitle': 'Drag files or folders here to add them',
  'image.dropDesc': 'Up to {count} items, {size} each',
  'image.dropBlocked': 'Attachments cannot be added right now',
  'file.pending': 'Pending file',
  'file.unknownType': 'Unknown file type',
  ...
  'file.invalid': 'The file metadata is invalid; re-add it and try again',
  'file.subagentUnsupported': 'Subagent sessions do not support file attachments yet',
  'attachment.sendFailed': 'Sending attachments failed ({reason}); re-add them and try again',
