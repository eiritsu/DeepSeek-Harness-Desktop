...
export const en: Record<AgentPresetSettingsKey, string> = {
  title: 'Agent preset',
  description: 'Applies to the current blank new session and sessions you start later. Running sessions keep their preset.',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  title: 'Agent 预设',
  description: '对当前空白新会话立即生效，并作用于此后新建的会话。运行中的会话保持原预设。',
  loading: '正在加载预设…',
  error: '无法加载 Agent 预设。',
  userTrust: '自定义',
