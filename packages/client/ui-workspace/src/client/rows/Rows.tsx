 ...
 * time->ellipsis, action buttons) are CSS-only. Row ... menus dispatch their
 * workspace and Session actions through prop callbacks; the Session and
...
export function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, onDelete, drag, flat = false, t }: {
  ...
  const ownRow = (
    ...
    >
      ...
      {/* Blank rows omit the timestamp and content-dependent rename/fork verbs,
          but still expose identity, archive, and delete management. */}
