...
export const zh = {
  ...
  'menu.attachSession': '加入工作区',
  'menu.deleteSession': '删除会话',
  'attach.sessionTitle': '加入工作区',
  'attach.sessionDesc': '选择要加入“{name}”的工作区。会话目录必须与工作区目录一致。',
  'attach.noWorkspaces': '暂无可用工作区。',
  'attach.pending': '正在加入工作区…',
  'delete.sessionDesc': '将永久删除“{name}”及其会话记录，无法恢复。',
...
export const en = {
  ...
  'menu.attachSession': 'Add to workspace',
  'menu.deleteSession': 'Delete session',
  'attach.sessionTitle': 'Add to workspace',
  'attach.sessionDesc': 'Choose a workspace for “{name}”. The session and workspace directories must match.',
  'attach.noWorkspaces': 'No workspaces are available.',
  'attach.pending': 'Adding to workspace…',
  'delete.sessionDesc': 'This permanently deletes “{name}” and its session history. This cannot be undone.',
