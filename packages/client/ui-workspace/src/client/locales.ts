...
export const zh = {
  ...
  'delete.session': '删除会话',
  'delete.session.desc': '将永久删除“{name}”的会话记录及其所有分叉或子会话。此操作无法撤销。',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently deletes “{name}”, its session log, and every fork or child session. This cannot be undone.',
