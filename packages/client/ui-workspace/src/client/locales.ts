...
export const zh = {
  ...
  'menu.fork': '分叉',
  'menu.archiveSession': '归档',
  'menu.attachWorkspace': '加入工作区',
  'menu.deleteSession': '删除会话',
  'delete.session.title': '删除会话',
  'delete.session.desc': '将永久删除“{name}”及其分叉会话。此操作无法撤销。',
...
export const en = {
  ...
  'menu.fork': 'Fork',
  'menu.archiveSession': 'Archive',
  'menu.attachWorkspace': 'Add to workspace',
  'menu.deleteSession': 'Delete session',
  'delete.session.title': 'Delete session',
  'delete.session.desc': 'This permanently deletes “{name}” and its forked sessions. This action cannot be undone.',
