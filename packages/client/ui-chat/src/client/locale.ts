...
export const zh = {
  ...
  'stats.cacheReadConfirmed': '已确认命中 {count}',
  ...
  'message.turnUsage.cacheReadConfirmed': '已确认缓存读取',
...
export const en = {
  ...
  'stats.cacheReadConfirmed': 'Confirmed hit {count}',
  ...
  'message.turnUsage.cacheReadConfirmed': 'Confirmed cached input',
