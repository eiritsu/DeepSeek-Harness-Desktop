...
export const zh = {
  ...
  'message.retryInterrupted.action': '重试',
  'message.retryInterrupted.failed': '重试失败',
  'message.retryInterrupted.unavailable': '无法重试此回答',
...
export const en = {
  ...
  'message.retryInterrupted.action': 'Retry',
  'message.retryInterrupted.failed': 'Retry failed',
  'message.retryInterrupted.unavailable': 'This answer can no longer be retried',
