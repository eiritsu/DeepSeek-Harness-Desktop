...
export const zh = {
  ...
  'message.attachmentExtracted': '文档内容 · {name}',
  ...
  'message.resend.action': '编辑并重发',
  'message.resend.editorLabel': '编辑消息并重发',
  'message.resend.submit': '重发',
  'message.resend.failed': '重发失败',
  'message.resend.unavailable': '无法重发此消息',
  'message.resume.action': '继续',
  'message.resume.failed': '继续失败',
  'message.resume.unavailable': '无法继续此轮',
...
export const en = {
  ...
  'stats.cacheUnreported': 'Cache not reported',
  ...
  'message.attachmentExtracted': 'Document content · {name}',
  ...
  'message.resend.action': 'Edit and resend',
  'message.resend.editorLabel': 'Edit message and resend',
  'message.resend.submit': 'Resend',
  'message.resend.failed': 'Resend failed',
  'message.resend.unavailable': 'This message can no longer be resent',
  'message.resume.action': 'Continue',
  'message.resume.failed': 'Continue failed',
  'message.resume.unavailable': 'This turn can no longer continue',
