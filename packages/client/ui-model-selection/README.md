...
- **No arbitrary effort input** — the composer offers only `Default`, `Off`, `Low`, `High`, and `Max`; a provider may reject an explicit level it does not implement.
