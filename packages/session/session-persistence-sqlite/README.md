...
- **No trash or background historical compaction** — explicit Session deletion removes its `sessions` row and cascading event rows in one transaction; normal appends remain insert-only.
