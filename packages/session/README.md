...
| [`session-persistence-sqlite/`](session-persistence-sqlite/README.md) | Desktop backend: one transactional SQLite database with Session event counts and revisions | registers on `ctx.sessionPersistence` |
