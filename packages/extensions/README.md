...
| [`external-tools`](external-tools/README.md) | Credential-gated external providers and the Settings → Tools & connections surface | provides `ctx.externalTools`; registers provider tools |
