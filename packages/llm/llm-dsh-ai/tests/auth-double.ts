...
import type { DshAiAuthInjection } from '../src/adapter.ts'
 ...
 * @returns the injection to hand `DshAiAdapter`, with its store readable.
 */
export function memoryAuth(seed: Record<string, Credential> = {}): DshAiAuthInjection & {
