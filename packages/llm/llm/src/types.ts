...
export interface ImageBlock {
  ...
  /** Bounded OCR text recorded when a text-only model requires recognition at admission. */
  recognizedText?: string
}

/** A durable generic file reference retained in user or assistant content. */
export interface FileBlock {
  type: 'file'
  /** Immutable original bytes and display metadata owned by the attachment service. */
  attachment: FileAttachmentRef
  /** Bounded semantic text produced by the active file-recognition plugin at admission. */
  recognizedText?: string
}
...
export interface LlmModelDiscoveryEnricher {
  /**
...
export interface LlmModelInputResolver {
  /**
