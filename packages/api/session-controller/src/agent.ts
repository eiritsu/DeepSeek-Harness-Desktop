...
export class ApiSessionAgentController {
   ...
   * @param sessionId - Session whose live ownership must permit deletion.
   */
   ...
   * @param sessionId - Session whose API-owned Agent should be disposed.
   */
  ...
  /**
   * Create a fork Agent under the same API-owned lifecycle registry.
   * @param options - fork Session and Agent construction options.
