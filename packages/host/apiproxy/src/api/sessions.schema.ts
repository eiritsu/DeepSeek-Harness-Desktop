...
import type {
  AttachmentIdType, AttachmentRef, FileAttachmentLimits, ImageAttachmentLimits, ImageAttachmentRef,
...
/** Host-side validation for the boot-constant generic-file intake limits. */
export const fileLimitsProjectionSchema: z.ZodType<FileAttachmentLimits> = z.object({
...
/** Durable generic file reference returned from authenticated session lookup. */
...
export const sessionAttachmentValueSchema = z.object({
  attachment: z.union([imageAttachmentRefSchema, fileAttachmentRefSchema]) as z.ZodType<AttachmentRef>,
  data: z.string(),
