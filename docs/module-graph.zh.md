...
flowchart TD
  ...
  subgraph group_attachment["packages/attachment"]
    ...
    pkg_file_recognizer_office["file-recognizer-office"]
  end
  ...
  subgraph group_client["packages/client"]
    ...
    pkg_client_ui_lark["client-ui-lark"]
    ...
    pkg_client_ui_plugin_library["client-ui-plugin-library"]
  ...
  subgraph group_lark["packages/lark"]
    pkg_lark["lark"]
  end
  ...
  pkg_file_recognizer_office --> pkg_attachment
  pkg_file_recognizer_office --> pkg_credentials
  pkg_file_recognizer_office --> pkg_settings
  ...
  pkg_session_persistence_sqlite --> pkg_session_format_catalog
  ...
  pkg_external_tools --> pkg_credentials
  pkg_external_tools --> pkg_tools
  pkg_external_tools --> pkg_web
  ...
  pkg_repeat_tool_reminder --> pkg_sandbox
  ...
  pkg_lark --> pkg_agent
  pkg_lark --> pkg_agent_default_model
  pkg_lark --> pkg_attachment
  pkg_lark --> pkg_credentials
  pkg_lark --> pkg_home_paths
  pkg_lark --> pkg_llm
  pkg_lark --> pkg_session
  pkg_lark --> pkg_session_persistence
  pkg_lark --> pkg_session_query
  pkg_lark --> pkg_settings
  pkg_lark --> pkg_subprocess
  pkg_lark --> pkg_time_context
  pkg_lark --> pkg_tools
  pkg_lark --> pkg_typert_protocol
  pkg_lark --> pkg_workspace
...
| [`desktop-lite`](../packages/bundle/desktop-lite) | `bundle` | — |
...
| [`client-ui-lark`](../packages/client/ui-lark) | `client` | — |
...
| [`client-ui-plugin-library`](../packages/client/ui-plugin-library) | `client` | — |
...
| [`file-recognizer-office`](../packages/attachment/file-recognizer-office) | `attachment` | [`attachment`](../packages/attachment/attachment), [`credentials`](../packages/credentials/credentials), [`settings`](../packages/settings/settings) |
...
| [`session-persistence-sqlite`](../packages/session/session-persistence-sqlite) | `session` | [`session`](../packages/core/session), [`session-format-catalog`](../packages/session/session-format-catalog), [`session-persistence`](../packages/session/session-persistence) |
...
| [`external-tools`](../packages/extensions/external-tools) | `extensions` | [`credentials`](../packages/credentials/credentials), [`tools`](../packages/core/tools), [`web`](../packages/web/web) |
...
| [`repeat-tool-reminder`](../packages/guard/repeat-tool-reminder) | `guard` | [`agent`](../packages/core/agent), [`sandbox`](../packages/sandbox/sandbox), [`tools`](../packages/core/tools) |
...
| [`lark`](../packages/lark/lark) | `lark` | [`agent`](../packages/core/agent), [`agent-default-model`](../packages/core/agent-default-model), [`attachment`](../packages/attachment/attachment), [`credentials`](../packages/credentials/credentials), [`home-paths`](../packages/util/home-paths), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence), [`session-query`](../packages/session-query/session-query), [`settings`](../packages/settings/settings), [`subprocess`](../packages/subprocess/subprocess), [`time-context`](../packages/context/time-context), [`tools`](../packages/core/tools), [`typert-protocol`](../packages/typert/protocol), [`workspace`](../packages/workspace/workspace) |
