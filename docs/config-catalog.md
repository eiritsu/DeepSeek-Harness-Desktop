...
Requires: `computerUse` · `tools` · `systemPrompt`
...
Source: [`packages/computer-use/cua-driver-native/src/index.ts:29`](../packages/computer-use/cua-driver-native/src/index.ts)
...
Requires: `agents` · `agentDefaultModel` · `attachments` · `credentials` · `sessionPersistence` · `sessionQuery` · `settings` · `subprocess` · `tools` · `workspaceRegistry`
...
Source: [`packages/lark/lark/src/index.ts:68`](../packages/lark/lark/src/index.ts)
...
Source: [`packages/llm/model-catalog/src/index.ts:38`](../packages/llm/model-catalog/src/index.ts)
...
Source: [`packages/session/session-persistence-sqlite/src/index.ts:56`](../packages/session/session-persistence-sqlite/src/index.ts)
...
Source: [`packages/fs/tool-fs/src/index.ts:29`](../packages/fs/tool-fs/src/index.ts)
