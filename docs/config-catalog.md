...
Source: [`packages/attachment/attachment-local/src/index.ts:76`](../packages/attachment/attachment-local/src/index.ts)
...
Source: [`packages/attachment/file-recognizer-office/src/index.ts:36`](../packages/attachment/file-recognizer-office/src/index.ts)
...
Depends on: `CacheRetention` (`@earendil-works/pi-ai`) · [`ModelModality`](subsystems/llm-streaming.md) · `ModelThinkingLevel` (`@earendil-works/pi-ai`) · `OpenAICompletionsCompat` (`@earendil-works/pi-ai`) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts) · `ThinkingBudgets` (`@earendil-works/pi-ai`) · `Transport` (`@earendil-works/pi-ai`)
...
Source: [`packages/llm/model-catalog/src/index.ts:29`](../packages/llm/model-catalog/src/index.ts)
