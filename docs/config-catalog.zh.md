...
export interface Config {
  ...
  /** Maximum bytes accepted for one generic file. Default: 32 MiB. */
  maxFileBytes?: number
  /** Maximum generic file count accepted in one submitted message. Default: 20. */
  maxFilesPerMessage?: number
  /** Maximum aggregate generic file bytes accepted in one submitted message. Default: 100 MiB. */
  maxMessageFileBytes?: number
}
```

来源：[`packages/attachment/attachment-local/src/index.ts:76`](../packages/attachment/attachment-local/src/index.ts)
...
来源：[`packages/attachment/file-recognizer-office/src/index.ts:36`](../packages/attachment/file-recognizer-office/src/index.ts)
...
export interface DeepSeekCatalogModel {
  ...
  maxTokens?: number
  /** Accepted request modalities implemented by the direct chat-completions serializer; omission is text-only. */
  inputModalities?: Extract<ModelModality, 'text' | 'image'>[]
...
依赖：[`ModelModality`](subsystems/llm-streaming.zh.md) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts)
...
/** One model input modality accepted by a pi-ai-backed route. */
