 ...
 */
@Remote('resend') resend(request: SessionResendRequest): Promise<SessionResendValue>
 ...
 */
@Remote('resume') resume(request: SessionResumeRequest): Promise<SessionResumeValue>
